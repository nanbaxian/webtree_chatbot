...
const CHINESE_QUERY_HINTS = [
  ...
  { pattern: /(正规|正宗|正经|正不正规|正式|合法的吗|靠不靠谱|靠谱|认可|认证|注册|教育局|教育部|学历|文凭|牌照|资质|办学许可|private school|inspected|accredited)/i, terms: 'Ministry of Education-inspected private school BSID 883796 private school credit courses university application guidance' },
